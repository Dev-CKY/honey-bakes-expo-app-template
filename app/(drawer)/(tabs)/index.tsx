...
const Home = () => {
  ...
  useFocusEffect(
    useCallback(() => {
      ...
      StatusBar.setBackgroundColor("#F7BC5D", true);
      StatusBar.setTranslucent(true);

      return () => {
        StatusBar.setBarStyle("dark-content", true);
        StatusBar.setBackgroundColor("#FFFFE3", true);
        StatusBar.setTranslucent(true);
      };
    }, []),
  );
  ...
  const handleScroll = (event: NativeSyntheticEvent<NativeScrollEvent>) => {
    ...
    const headerVisible = offsetY < HEADER_HEIGHT;
